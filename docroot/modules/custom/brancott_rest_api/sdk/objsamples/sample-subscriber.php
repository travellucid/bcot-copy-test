...
try {	
	...
	$subCreate->props = array("EmailAddress" => $SubscriberTestEmail, "SubscriberKey" => "SDKSubscriber");
	...
	$retSub->filter = array('Property' => 'EmailAddress','SimpleOperator' => 'equals','Value' => $SubscriberTestEmail);
	...
	$subPatch->props = array("EmailAddress" => $SubscriberTestEmail, "Status" => "Unsubscribed", "SubscriberKey" => "SDKSubscriber");
