        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                customPaging: function(slider, i) {
                    return '<button type="button" data-role="none" role="button" aria-hidden="true" aria-required="false" tabindex="-1">Go to Slide ' + (i + 1) + '</button>';
                },
                dots: false,
...
//                .removeAttr('aria-hidden aria-disabled tabindex')
    ...
    Slick.prototype.setSlideClasses = function(index) {
        ...
        allSlides = _.$slider
            ...
            .attr('aria-hidden', 'false'); // Fixed for Accessibility
...
//                .attr('aria-hidden', 'false');
    ...
    Slick.prototype.activateADA = function() {
		...
		// Added for accessibility of Carousel slides which are Anchor themselves.
		_.$slideTrack.find('a.slick-active').attr({
			'tabindex': '0'
		});
